                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('descripcion') ? ' has-danger' : '' }}">  
                       <textarea class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" id="input-descripcion" type="" placeholder="{{ __('descripcion') }}" value="{{ old('descripcion') }}" required rows="3"></textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('fecha') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('fecha') ? ' is-invalid' : '' }}" input type="date" name="fecha" id="input-fecha" placeholder="{{ __('fecha') }}" value="" required />
                      @if ($errors->has('fecha'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="hora" id="input-hora" type="time" placeholder="{{ __('Hora') }}" value="" required />
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-control-file">
                      <input class="form-control-file" name="imagen" id="input-imagen" type="file" required />
                    </div>
                  </div>
                </div>  <br>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('estado') ? ' has-danger' : '' }}">
                      <div class="togglebutton">
                        <label>
                          <input name="estado" type="checkbox" checked="" value="1">
