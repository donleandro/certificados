                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name2') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name2') ? ' is-invalid' : '' }}" name="name2" id="input-name2" type="text" placeholder="{{ __('Segundo nombre') }}" value="{{ old('name2', $user->name2) }}" required="true" aria-required="true"/>
                      @if ($errors->has('name2'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('apellido') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('apellido') ? ' is-invalid' : '' }}" name="apellido" id="input-apellido" type="text" placeholder="{{ __('Primer apellido') }}" value="{{ old('apellido', $user->apellido) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('apellido2') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('apellido2') ? ' is-invalid' : '' }}" name="apellido2" id="input-apellido2" type="text" placeholder="{{ __('Segundo apellido') }}" value="{{ old('apellido2', $user->apellido2) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('tipo_doc') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('tipo_doc') ? ' is-invalid' : '' }}" name="tipo_doc" id="input-tipo_doc" type="text" placeholder="{{ __('Tipo documento') }}" value="{{ old('tipo_doc', $user->tipo_doc) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('documento') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('documento') ? ' is-invalid' : '' }}" name="documento" id="input-documento" type="text" placeholder="{{ __('Documento') }}" value="{{ old('documento', $user->documento) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('profesion') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('profesion') ? ' is-invalid' : '' }}" name="profesion" id="input-profesion" type="text" placeholder="{{ __('Profesión') }}" value="{{ old('profesion', $user->profesion) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('cargo') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('cargo') ? ' is-invalid' : '' }}" name="cargo" id="input-cargo" type="text" placeholder="{{ __('Cargo') }}" value="{{ old('cargo', $user->cargo) }}" required="true" aria-required="true"/>
                      @if ($errors->has('cargo'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('celular') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('celular') ? ' is-invalid' : '' }}" name="celular" id="input-celular" type="number" placeholder="{{ __('Celular') }}" value="{{ old('celular', $user->celular) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('direccion') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('direccion') ? ' is-invalid' : '' }}" name="direccion" id="input-direccion" type="text" placeholder="{{ __('Direccion') }}" value="{{ old('direccion', $user->direccion) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('medio') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('medio') ? ' is-invalid' : '' }}" name="medio" id="input-medio" type="text" placeholder="{{ __('Medio') }}" value="{{ old('medio', $user->medio) }}" required="true" aria-required="true"/>
                      @if ($errors->has('medio'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('tipo_persona') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('tipo_persona') ? ' is-invalid' : '' }}" name="tipo_persona" id="input-tipo_persona" type="text" placeholder="{{ __('Tipo persona') }}" value="{{ old('tipo_persona', $user->tipo_persona) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('asistencia_minima') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('asistencia_minima') ? ' is-invalid' : '' }}" name="asistencia_minima" id="input-asistencia_minima" type="text" placeholder="{{ __('Tipo persona') }}" value="{{ old('asistencia_minima', $user->asistencia_minima) }}" required="true" aria-required="true"/>
